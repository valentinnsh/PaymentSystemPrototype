...
namespace PaymentSystemPrototype.Migrations
{
    ...
    [Migration("20220331145934_Fixed_Role_to_UserRole_connection")]
    partial class Fixed_Role_to_UserRole_connection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PaymentSystemPrototype.Models.UserRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Igorev",
                            Password = "password",
                            RegisteredAt = new DateTime(2022, 3, 31, 14, 59, 33, 921, DateTimeKind.Utc).AddTicks(2532)
                        });
                });
